...
> **Status: in progress.** Chapters 1 to 3 are done. Chapters are written in
...
| 4 | Loop control and cost | Turn caps, dollar caps, cycle detection. Why agents repeat themselves. | next |
